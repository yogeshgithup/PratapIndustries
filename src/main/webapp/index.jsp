                ...
                <div class="grid_3 grid_5">
                    <div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
                       <ul class="nav nav-tabs" >
                            <li class="active"><a href="#expeditions" id="expeditions-tab" >Featured Products</a></li>
                             </ul>
                                                    ...
                                                    <figure>
                                                        <div class="snipcart-item block" >
                                                            <div class="snipcart-thumb">
                                                                <a href="products.html"><img title=" " alt=" " src="images/hosp.jpg" /></a>		
                                                                <p>Hospital Uniform</p>
                                                            ...
                                                            <div class="snipcart-details top_brand_home_details">
                                                                <form action="#" method="post">
                                                                    <fieldset>
                                                                        ...
                                                                        <input type="button" name="submit" value="View More" class="button" onclick="location.href='single.jsp'";/>
                                                                    </fieldset>
                                                                </form>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="agile_top_brand_left_grid">
                                                ...
                                                <div class="agile_top_brand_left_grid1">
                                                    <figure>
                                                        <div class="snipcart-item block">
                                                            <div class="snipcart-thumb">
                                                                <a href="products.html"><img src="images/hosp.jpg" alt=" " class="img-responsive" /></a>
                                                                <p>Hotel Uniform</p>
